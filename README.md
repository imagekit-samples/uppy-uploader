...
uppy-uploader/
├── client/
│   ├── index.html        # Main HTML file with Uppy Dashboard Container
│   ├── index.js          # Client-side upload logic & Uppy setup
│   └── style.css         # Dark theme styling
├── server/
│   └── index.js          # Express server with ImageKit SDK
├── dist/                 # Compiled assets (generated by Parcel)
...
Monitor your uploads in [ImageKit Dashboard](https://imagekit.io/dashboard/dashboard):
- Storage usage
- API request logs
- Upload statistics
- File management
